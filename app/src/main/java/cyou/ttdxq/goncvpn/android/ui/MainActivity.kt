...
import cyou.ttdxq.goncvpn.android.util.isValidIpAddressInput
    ...
    private fun startVpnService() {
        ...
        scope.launch {
            ...
            val intent = Intent(this@MainActivity, GoncVpnService::class.java).apply {
                ...
                putExtra(GoncVpnService.EXTRA_CUSTOM_STUN_SERVERS, customStunServers)
                putExtra(GoncVpnService.EXTRA_CUSTOM_MQTT_SERVERS, customMqttServers)
            }
            try {
